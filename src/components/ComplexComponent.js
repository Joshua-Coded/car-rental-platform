            ...
            <div className="flex-1 md:w-1/2">
                <div className="mb-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                        <div className="bg-gray-800 p-4 rounded-lg shadow-md flex flex-col items-center w-40">
                            <FaPhone className="text-red-600 text-xl mb-2" />
                            <p className="text-sm text-center">Partition Cabin with Intercom</p>
                        </div>
                        <div className="bg-gray-800 p-4 rounded-lg shadow-md flex flex-col items-center w-40">
                            <FaRegSnowflake className="text-red-600 text-xl mb-2" />
                            <p className="text-sm text-center">Refrigerated Refreshments</p>
                        </div>
                        <div className="bg-gray-800 p-4 rounded-lg shadow-md flex flex-col items-center w-40">
                            <FaPlug className="text-red-600 text-xl mb-2" />
                            <p className="text-sm text-center">Multi Cabin Charging Functionality</p>
                        </div>
                        <div className="bg-gray-800 p-4 rounded-lg shadow-md flex flex-col items-center w-40">
                            <FaWifi className="text-red-600 text-xl mb-2" />
                            <p className="text-sm text-center">In Cabin Wifi Functionality</p>
                        </div>
                        <div className="bg-gray-800 p-4 rounded-lg shadow-md flex flex-col items-center w-40">
                            <FaTv className="text-red-600 text-xl mb-2" />
                            <p className="text-sm text-center">In Cabin Entertainment</p>
                        </div>
                        <div className="bg-gray-800 p-4 rounded-lg shadow-md flex flex-col items-center w-40">
                            <FaWhatsapp className="text-red-600 text-xl mb-2" />
                            <p className="text-sm text-center">Communication</p>
                        </div>
                        <div className="bg-gray-800 p-4 rounded-lg shadow-md flex flex-col items-center w-40">
                            <FaHandshake className="text-red-600 text-xl mb-2" />
