            ...
            <motion.div className="flex flex-col md:flex-row justify-center items-center space-y-6 md:space-y-0 md:space-x-12" variants={fadeInUp} whileInView="visible" viewport={{ once: false }}>
                <motion.div className="flex-1 text-center md:text-left" variants={fadeInUp} whileInView="visible" viewport={{ once: false }}>
                    ...
                    <motion.div className="grid grid-cols-1 md:grid-cols-2 gap-4 justify-center" variants={staggerContainer}>
                        <motion.div className="bg-gray-900 p-4 rounded-lg shadow-md flex flex-col items-center w-full max-w-xs mx-auto" variants={fadeInUp} whileInView="visible" viewport={{ once: false }}>
                            <motion.div variants={fadeInUp} whileInView="visible" viewport={{ once: false }}>
                                <FaPhone className="text-red-600 text-4xl mb-2" />
                            </motion.div>
                        ...
                        <motion.div className="bg-gray-900 p-4 rounded-lg shadow-md flex flex-col items-center w-full max-w-xs mx-auto" variants={fadeInUp} whileInView="visible" viewport={{ once: false }}>
                            <motion.div variants={fadeInUp} whileInView="visible" viewport={{ once: false }}>
                                <FaRegSnowflake className="text-red-600 text-4xl mb-2" />
                            </motion.div>
                        ...
                        <motion.div className="bg-gray-900 p-4 rounded-lg shadow-md flex flex-col items-center w-full max-w-xs mx-auto" variants={fadeInUp} whileInView="visible" viewport={{ once: false }}>
                            <motion.div variants={fadeInUp} whileInView="visible" viewport={{ once: false }}>
                                <FaPlug className="text-red-600 text-4xl mb-2" />
                            </motion.div>
                        ...
                        <motion.div className="bg-gray-900 p-4 rounded-lg shadow-md flex flex-col items-center w-full max-w-xs mx-auto" variants={fadeInUp} whileInView="visible" viewport={{ once: false }}>
                            <motion.div variants={fadeInUp} whileInView="visible" viewport={{ once: false }}>
                                <FaWifi className="text-red-600 text-4xl mb-2" />
                            </motion.div>
                        ...
                        <motion.div className="bg-gray-900 p-4 rounded-lg shadow-md flex flex-col items-center w-full max-w-xs mx-auto" variants={fadeInUp} whileInView="visible" viewport={{ once: false }}>
                            <motion.div variants={fadeInUp} whileInView="visible" viewport={{ once: false }}>
                                <FaTv className="text-red-600 text-4xl mb-2" />
                            </motion.div>
                        ...
                        <motion.div className="bg-gray-900 p-4 rounded-lg shadow-md flex flex-col items-center w-full max-w-xs mx-auto" variants={fadeInUp} whileInView="visible" viewport={{ once: false }}>
                            <motion.div variants={fadeInUp} whileInView="visible" viewport={{ once: false }}>
                                <FaWhatsapp className="text-red-600 text-4xl mb-2" />
                            </motion.div>
                        ...
                        <motion.div className="bg-gray-900 p-4 rounded-lg shadow-md flex flex-col items-center w-full max-w-xs mx-auto" variants={fadeInUp} whileInView="visible" viewport={{ once: false }}>
                            <motion.div variants={fadeInUp} whileInView="visible" viewport={{ once: false }}>
                                <FaHandshake className="text-red-600 text-4xl mb-2" />
                            </motion.div>
