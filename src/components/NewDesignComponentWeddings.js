...
const NewDesignComponentWeddings = () => {
        ...
        <div className="bg-black text-white py-10 px-6 flex flex-col md:flex-row space-y-12 md:space-y-0 md:space-x-12">
            <div className="flex-1 md:w-2/3 bg-gray-900 p-6 rounded-lg">
                <div className="mb-8">
                    ...
                    <h1 className="text-3xl font-bold mb-4">Car Interior Features for weddings ceremonies</h1>
                    ...
                    <div className="flex space-x-4 mt-6">
                        <button className="bg-red-600 text-white px-4 py-2 rounded hover:bg-red-700">Book Now</button>
                    </div>
                </div>
            </div>
            <div className="flex-1 md:w-1/3 flex flex-col justify-center items-center">
                ...
                <button className="bg-red-600 text-white px-4 py-2 text-center rounded hover:bg-red-700">Book Now</button>
            </div>
...
export default NewDesignComponentWeddings;
