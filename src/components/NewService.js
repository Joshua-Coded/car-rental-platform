    ...
    return (
        ...
        >
            ...
            <motion.div className="flex flex-col items-center" variants={fadeInUp}>
                ...
                <motion.h2 className='text-1.8xl text-center text-[#000D28]]'>Business Travel Services</motion.h2><br />
            ...
            <motion.div className="flex flex-col items-center" variants={fadeInUp}>
                ...
                <motion.h2 className='text-1.8xl text-center text-[#000D28]'>Wedding Services</motion.h2><br />
            ...
            <motion.div className="flex flex-col items-center" variants={fadeInUp}>
                ...
                <motion.h2 className='text-1.8xl text-center text-[#000D28]'>Airport Transfers</motion.h2><br />
            ...
            <motion.div className="flex flex-col items-center" variants={fadeInUp}>
                ...
                <motion.h2 className='text-1.8xl text-center text-[#000D28]'>Special Events</motion.h2><br />
            ...
            <motion.div className="flex flex-col items-center" variants={fadeInUp}>
                ...
                <motion.h2 className='text-1.8xl text-center text-[#000D28]'>Customizable Packages</motion.h2><br />
            ...
            <motion.div className="flex flex-col items-center" variants={fadeInUp}>
                ...
                <motion.h2 className='text-1.8xl text-center text-[#000D28]'>Safety and Comfort</motion.h2><br />
